// ═══════════════════════════════════════════════════════════
// main-cliente.js — Punto de entrada de la app del cliente
// Sin backend: solo cotiza y manda la solicitud por WhatsApp.
// ═══════════════════════════════════════════════════════════
...
function abrirMapaNativo() {
  ...
  if (esIOSDispositivo()) {
    // Apple Maps: abre la app nativa directo en iPhone/iPad.
    window.location.href = `maps://maps.apple.com/?saddr=${oLat},${oLon}&daddr=${dLat},${dLon}&dirflg=d`;
  } else {
    // Google Maps: en Android, si la app está instalada, este link la abre nativa
    // (no en el navegador). Si no está instalada, abre la versión web como respaldo.
